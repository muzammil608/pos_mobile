...
class AuthService {
  ...
  Future<UserModel> login(String email, String password) async {
    try {
      ...
      // Login is complete as soon as authentication succeeds. Updating this
      // optional audit field must not delay navigation on a mobile network or
      // turn a successful login into an error if the follow-up request fails.
      unawaited(
        PocketBaseClient.pb.collection('users').update(record.id, body: {
